...
#include "StudyProject/Public/Game/SGameMode.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeSGameMode() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_AGameModeBase();
	STUDYPROJECT_API UClass* Z_Construct_UClass_ASGameMode();
	STUDYPROJECT_API UClass* Z_Construct_UClass_ASGameMode_NoRegister();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASGameMode_Statics::Class_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/Game/SGameMode.h" },
	...
	template<> STUDYPROJECT_API UClass* StaticClass<ASGameMode>()
	{
		return ASGameMode::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ASGameMode);
	ASGameMode::~ASGameMode() {}
	struct Z_CompiledInDeferFile_FID_unreal_StudyProject_Source_StudyProject_Public_Game_SGameMode_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_unreal_StudyProject_Source_StudyProject_Public_Game_SGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASGameMode, ASGameMode::StaticClass, TEXT("ASGameMode"), &Z_Registration_Info_UClass_ASGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASGameMode), 808420347U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_unreal_StudyProject_Source_StudyProject_Public_Game_SGameMode_h_3782060810(TEXT("/Script/StudyProject"),
		Z_CompiledInDeferFile_FID_unreal_StudyProject_Source_StudyProject_Public_Game_SGameMode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_unreal_StudyProject_Source_StudyProject_Public_Game_SGameMode_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
